...
namespace BookStoreAPI.Controllers
{
    ...
    public class LibroesController : ControllerBase
    {
        ...
        //ficcion
        [HttpGet("/BuscarCategoriaFiccion")]
        public async Task<IEnumerable<Libro>> BuscarCategoriaFiccion()
        {
        ...
        //Misterio
        [HttpGet("/BuscarCategoriaMisterio")]
        public async Task<IEnumerable<Libro>> BuscarCategoriaMisterio()
        {
        ...
        //Clasico
        [HttpGet("/BuscarCategoriaClasico")]
        public async Task<IEnumerable<Libro>> BuscarCategoriaClasico()
        {
        ...
        //Fantasia
        [HttpGet("/BuscarCategoriaFantasia")]
        public async Task<IEnumerable<Libro>> BuscarCategoriaFantasia()
        {
